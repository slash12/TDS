...
/*---------------------Image Validation-----------------------------*/
               ...
               if($imgcheck)
               {
                 move_uploaded_file($_FILES["upload_file"]["tmp_name"][0], "$folder"."check".$_FILES["upload_file"]["name"][0]);
                 echo "done";
                 echo $target_file;
               }
               else
      ...
      <table>
        <tr>
          <td rowspan="6">
            ...
            <center><input type="submit" class="button" name="btnsubmit" value="Upload Image"></center>
          </td>
        </tr>
        <tr>
          <td>Username</td>
